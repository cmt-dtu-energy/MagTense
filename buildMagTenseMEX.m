...
mex -g -Lsource\NumericalIntegration\NumericalIntegration\x64\Release\ -lNumericalIntegration ...
       ...
       '-LC:\Program Files (x86)\sundials\inst_dir\lib' -lsundials_nvecserial ...
       '-LC:\Program Files (x86)\sundials\inst_dir\lib' -lsundials_sunmatrixdense ...
       '-LC:\Program Files (x86)\sundials\inst_dir\lib' -lsundials_sunlinsoldense ...
       '-LC:\Program Files (x86)\sundials\inst_dir\lib' -lsundials_fnvecserial_mod ...
       '-LC:\Program Files (x86)\sundials\inst_dir\lib' -lsundials_cvode ...
       '-LC:\Program Files (x86)\sundials\inst_dir\lib' -lsundials_fsunnonlinsolfixedpoint_mod ... ...       
       '-IC:\Program Files (x86)\sundials\inst_dir\include' ...       
