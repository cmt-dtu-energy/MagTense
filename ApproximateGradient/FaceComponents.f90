module FaceComponents
    ...
    !::General base-type for alle the different face types
    type TileFace
        real,dimension(3) :: normal !::defines the direction of the norm (at the center) of the face
	...
	subroutine setupFaceStructureFromGrid(tiles, faces, n_tiles)
	import TileFace
	type(TileFace),dimension(:),allocatable :: faces
	type(MagTile),dimension(n_tiles),intent(in) :: tiles
        ...
        enddo
	end subroutine setupFaceStructureFromGrid
