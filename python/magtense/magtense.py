...
def run_micromag_simulation(problem):
    ...
    t, M, pts, H_exc, H_ext, H_dem, H_ani = magtensesource.fortrantopythonio.runmicromagsimulation( 
        ntot=problem.ntot,
        ...
        grid_nod=problem.grid_nod,
        grid_nnod=problem.grid_nnod,
        exch_nval=problem.exch_nval,
        exch_nrow=problem.exch_nrow,
        exch_val=problem.exch_val,
        exch_rows=problem.exch_rows,
        exch_rowe=problem.exch_rowe,
        exch_col=problem.exch_col,
