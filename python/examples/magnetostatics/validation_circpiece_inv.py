...
def valid_circ_inv():    
    ...
    tile_val.center_pos = [0.3, math.pi/0.55, 0.6]
    tile_val.dev_center = [0.15, math.pi/6, 0.4]
    tile_val.offset = ([0.3, 0.5, 0.1], 0)
    tile_val.rot = ([0, 0, 0], 0)
    tile_val.tile_type = 4
    tile_val.M_rem = (1.2 / (4*math.pi*1e-7))
    tile_val.u_ea = [0.41562694, 0.41562694, 0.80901699]
