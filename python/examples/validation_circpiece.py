...
def main():
    ...
    tile_val.set_center_pos([[0.5, math.pi/4, 0.5]])
    tile_val.set_dev_center([0, math.pi/6, 0.2])
    tile_val.set_offset_i([0.4, 0.3, 0.1],0)
    ...
    util_plot.create_plot(tile_val, points, H, grid=grid)
