...
LABEL_LIST=("cuda" "cuda" "cuda" "cuda" "cuda" "cuda" )

# Mesh parameter per run (uniform grid perf: rasBase only)
BASES_LIST=(10 13 16 20 25 31)

# FMM controls per run
CPN_LIST=(100 100 100 100 100 100)
IFUNIF_LIST=(1 1 1 1 1 1)                 # 1 uniform, 0 adaptive
NLMIN_LIST=(1 1 1 1 1 1)
NLMAX_LIST=(2 2 2 2 2 2)
ALLOW_FMM_SHORT_CIRCUIT_LIST=(1 1 1 1 1 1)  # 0/1 (int-style)
FMM_MIN_N_LIST=(30000 30000 30000 30000 30000 30000)
FMM_NTERMS_LIST=(-1 -1 -1 -1 -1 -1)  # -1 means default nterms based on eps
