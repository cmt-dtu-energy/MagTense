function MeshTests_VoronoiTestB
% close all ;
...
n_Tc = 5 ; % number of grains (i.e. number of Voronoi cells)
%     base_res = 1.*[4,4,4] ;
base_res = [1*9,1*7,5] ;
L = 2 ; % number of refinment iterations from base_res
...
VoronoiMeshFileName = 'TestVoronoiMesh02.mat' ;
...
MySim_ini.DemagTensorFileName = 'VoronoiInteractionMatrices2.mat' ;
