...
if (USE_CVODE)
    ...
    if (ispc)
        ...
        CVODE = ['-L' cvode_lib ' sundials_core.a sundials_cvode.a sundials_fcore_mod.a sundials_fcvode_mod.a sundials_fnvecserial_mod.a sundials_fsunmatrixdense_mod.a sundials_fsunlinsolspgmr_mod.a'];
    end
else
    CVODE_include = '';
    CVODE = '';
