...
if (USE_CVODE)
    ...
    if (ispc)
        ...
        CVODE = ['-L' cvode_lib ' libsundials_core.a libsundials_cvode.a libsundials_fcore_mod.a libsundials_fcvode_mod.a libsundials_fnvecserial_mod.a libsundials_fsunmatrixdense_mod.a libsundials_fsunlinsolspgmr_mod.a'];
    end
else
    CVODE_include = '';
    CVODE = '';
