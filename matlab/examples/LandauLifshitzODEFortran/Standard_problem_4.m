...
% figure; sjask = squeeze(problem.m0); quiver(solution.pts(:,1),solution.pts(:,2),sjask(:,1),sjask(:,2))
...
% figure; hold all; for i=1:3; plot(problem.t,mean(solution.M(:,:,i),2),'.-'); end;
% figure; plot(problem.Hext(:,1),problem.Hext(:,2),'.')
