...
ifeq ($(OS),Windows_NT)
	...
	LDFLAGS = '/DEFAULTLIB:msvcrt.lib /NODEFAULTLIB:libcmt.lib /LIBPATH:"C:\Program Files (x86)\Windows Kits\10\lib\10.0.26100.12\um\x64" /LIBPATH:"C:\Program Files (x86)\Windows Kits\10\lib\10.0.26100.12\ucrt\x64" /LIBPATH:"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\VC\Tools\MSVC\14.43.34808\lib\x64" /LIBPATH:${CONDA_PATH}/Library/lib'
	LIB_SUFFIX = .lib
	PY_MOD_SUFFIX = .pyd
